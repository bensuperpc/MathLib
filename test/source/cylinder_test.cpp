...
{
  auto data1 = my::math::cylinder::cylinderVolume<uint64_t>(1000, 5);
...
{
  auto data1 = my::math::cylinder::cylinderVolume<uint64_t>(151, 10);
...
{
  auto data1 = my::math::cylinder::cylinderVolume<uint64_t>(0, 0);
...
{
  auto data1 = my::math::cylinder::cylinderVolume<int>(32, 3);
...
{
  auto data1 = my::math::cylinder::cylinderVolume<int>(51, 2);
...
{
  auto data1 = my::math::cylinder::cylinderVolume<int>(0, 0);
...
{
  auto data1 = my::math::cylinder::cylinderSurface<uint64_t>(10000, 9);
...
{
  auto data1 = my::math::cylinder::cylinderSurface<uint64_t>(151, 6);
...
{
  auto data1 = my::math::cylinder::cylinderSurface<uint64_t>(0, 0);
  auto data2 = static_cast<uint64_t>(0);
...
{
  auto data1 = my::math::cylinder::cylinderSurface<int>(6598, 4);
...
{
  auto data1 = my::math::cylinder::cylinderSurface<int>(151, 6);
...
{
  auto data1 = my::math::cylinder::cylinderSurface<int>(0, 0);
  auto data2 = static_cast<int>(0);
