...
{
  auto data1 = my::math::sphere::sphereVolume<uint64_t>(10000);
...
{
  auto data1 = my::math::sphere::sphereVolume<uint64_t>(151);
...
{
  auto data1 = my::math::sphere::sphereVolume<uint64_t>(0);
...
{
  auto data1 = my::math::sphere::sphereSurface<uint64_t>(10000);
...
{
  auto data1 = my::math::sphere::sphereSurface<uint64_t>(151);
...
{
  auto data1 = my::math::sphere::sphereSurface<uint64_t>(0);
  auto data2 = static_cast<uint64_t>(0);
...
BOOST_AUTO_TEST_CASE(test_sphere_volume_3)
{
    BOOST_REQUIRE_MESSAGE(
        static_cast<boost::multiprecision::uint1024_t>(my::math::sphere::sphereVolume<boost::multiprecision::float128>(EARTH_RADIUS)
/ 1000000)
            == 1086832411937628777,
        static_cast<boost::multiprecision::uint1024_t>(my::math::sphere::sphereVolume<boost::multiprecision::float128>(EARTH_RADIUS)
/ 1000000)
