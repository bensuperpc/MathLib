...
TEST(random, basic_int_1) {
  ...
  auto result = ben::math::rand::random<int>(min, max);
...
TEST(random, basic_int_2) {
  ...
  auto result = ben::math::rand::random<int, false>(min, max);
  EXPECT_IN_RANGE(result, min, max);
}
...
TEST(random, basic_int_3) {
  ...
  ben::math::rand::random<int, false>(result, min, max);
  EXPECT_IN_RANGE(result, min, max);
}
...
TEST(random, basic_float_1) {
  ...
  auto result = ben::math::rand::random<float>(min, max);
  EXPECT_IN_RANGE(result, min, max);
}
...
TEST(random, basic_float_2) {
  ...
  auto result = ben::math::rand::random<float, false>(min, max);
  EXPECT_IN_RANGE(result, min, max);
}
...
TEST(random, basic_float_3) {
  ...
  ben::math::rand::random<float, false>(result, min, max);
  EXPECT_IN_RANGE(result, min, max);
}
...
TEST(random, basic_vec_int_1) {
  ...
  ben::math::rand::random<int, true>(vec, 0, 100);
...
TEST(random, basic_vec_int_2) {
  ...
  ben::math::rand::random<int, true>(vec, min, max);
  for (auto& vec_ : vec) {
    EXPECT_IN_RANGE(vec_, min, max);
  }
}
...
TEST(random, basic_vec_float_1) {
  ...
  ben::math::rand::random<float, true>(vec, min, max);
  for (auto& vec_ : vec) {
    EXPECT_IN_RANGE(vec_, min, max);
  }
}
...
TEST(random, basic_vec_double_1) {
  ...
  ben::math::rand::random<double, true>(vec, min, max);
  for (auto& vec_ : vec) {
    EXPECT_IN_RANGE(vec_, min, max);
  }
}
...
TEST(random, basic_arr_double_1) {
  ...
  ben::math::rand::random<double, true>(vec.data(), 5, min, max);
  for (auto& vec_ : vec) {
    EXPECT_IN_RANGE(vec_, min, max);
  }
}
...
TEST(random, basic_arr_int_1) {
  ...
  ben::math::rand::random<int, true>(vec.data(), 5, min, max);
  for (auto& vec_ : vec) {
    EXPECT_IN_RANGE(vec_, min, max);
  }
}
