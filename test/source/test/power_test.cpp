...
TEST(power, basic_uint64_t_1) {
  auto data1 = ben::math::power<uint64_t>(2, 16);
...
TEST(power, basic_uint64_t_2) {
  auto data1 = ben::math::power<uint64_t>(2, 32);
...
TEST(power, basic_uint64_t_3) {
  auto data1 = ben::math::power<uint64_t>(55, 0);
...
TEST(power, basic_int_4) {
  auto data1 = ben::math::power<int>(-5, 3);
