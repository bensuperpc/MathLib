...
TEST(sphereVolume, basic_uint64_t_1) {
  auto data1 = ben::math::sphere::sphereVolume<uint64_t>(10000);
...
TEST(sphereVolume, basic_uint64_t_2) {
  auto data1 = ben::math::sphere::sphereVolume<uint64_t>(151);
...
TEST(sphereVolume, basic_uint64_t_3) {
  auto data1 = ben::math::sphere::sphereVolume<uint64_t>(0);
...
TEST(sphereSurface, basic_uint64_t_1) {
  auto data1 = ben::math::sphere::sphereSurface<uint64_t>(10000);
...
TEST(sphereSurface, basic_uint64_t_2) {
  auto data1 = ben::math::sphere::sphereSurface<uint64_t>(151);
...
TEST(sphereSurface, basic_uint64_t_3) {
  auto data1 = ben::math::sphere::sphereSurface<uint64_t>(0);
  auto data2 = static_cast<uint64_t>(0);
...
BOOST_AUTO_TEST_CASE(test_sphere_volume_3)
{
    BOOST_REQUIRE_MESSAGE(
        static_cast<boost::multiprecision::uint1024_t>(ben::math::sphere::sphereVolume<boost::multiprecision::float128>(EARTH_RADIUS)
/ 1000000)
            == 1086832411937628777,
        static_cast<boost::multiprecision::uint1024_t>(ben::math::sphere::sphereVolume<boost::multiprecision::float128>(EARTH_RADIUS)
/ 1000000)
