...
TEST(cylinder_volume, basic_uint64_t_1) {
  auto data1 = ben::math::cylinder::cylinderVolume<uint64_t>(1000, 5);
...
TEST(cylinder_volume, basic_uint64_t_2) {
  auto data1 = ben::math::cylinder::cylinderVolume<uint64_t>(151, 10);
...
TEST(cylinder_volume, basic_uint64_t_3) {
  auto data1 = ben::math::cylinder::cylinderVolume<uint64_t>(0, 0);
...
TEST(cylinder_volume, basic_int_1) {
  auto data1 = ben::math::cylinder::cylinderVolume<int>(32, 3);
...
TEST(cylinder_volume, basic_int_2) {
  auto data1 = ben::math::cylinder::cylinderVolume<int>(51, 2);
...
TEST(cylinder_volume, basic_int_3) {
  auto data1 = ben::math::cylinder::cylinderVolume<int>(0, 0);
...
TEST(cylinder_surface, basic_uint64_t_1) {
  auto data1 = ben::math::cylinder::cylinderSurface<uint64_t>(10000, 9);
...
TEST(cylinder_surface, basic_uint64_t_2) {
  auto data1 = ben::math::cylinder::cylinderSurface<uint64_t>(151, 6);
...
TEST(cylinder_surface, basic_uint64_t_3) {
  auto data1 = ben::math::cylinder::cylinderSurface<uint64_t>(0, 0);
  auto data2 = static_cast<uint64_t>(0);
...
TEST(cylinder_surface, basic_int_1) {
  auto data1 = ben::math::cylinder::cylinderSurface<int>(6598, 4);
...
TEST(cylinder_surface, basic_int_2) {
  auto data1 = ben::math::cylinder::cylinderSurface<int>(151, 6);
...
TEST(cylinder_surface, basic_int_3) {
  auto data1 = ben::math::cylinder::cylinderSurface<int>(0, 0);
  auto data2 = static_cast<int>(0);
